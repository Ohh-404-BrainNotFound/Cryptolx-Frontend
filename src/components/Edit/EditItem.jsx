...
function EditItem() {
  return (
    <div>
        <h1 class="title" >Edit Item       <span style={{color: 'maroon', paddingLeft: '30px'}}>></span></h1>
        <div class="form">
        <form class="ui form">
            <div class="field">
            ...
            <div class="submitTop">
                <button class="ui button" type="submit" style={{backgroundColor: 'orange', color: 'white', font:"Gill Sans - Light"}}>Edit Changes</button>
            </div>
        </form>
        </div>
    </div>
