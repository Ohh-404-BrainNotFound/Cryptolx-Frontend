  ...
  return (
    ...
    <div className="overall">
      ...
      <div className="info">
        ...
        {/* Payment Info */}
        <h1 style={{ marginLeft: "100px", color: "Orange", font: "Gill Sans-Regular", fontStyle: "Italic", marginTop: "20px" }}>Payment Processed!!</h1>
        <p style={{ marginLeft: "100px", color: "Orange", fontStyle: "Italic", font: "Gill Sans-Regular" }}>Will reach you in 5-7 working days</p>

        {/* Buttons  */}

        <Button style={{ backgroundColor: "Maroon", color: "white", font: "Gill Sans - Light", marginLeft: "100px", marginTop:"15px" }}>Continue Shopping</Button>
